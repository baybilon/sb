...
settings = {
    ...
    "autoRead": False,
    "lang":"JP",
    "commentPost": "DPK BOT HADIR BUAT LIKE STATUS KAMU \n Add my owner ID http://line.me/ti/p/~bgstbgtya",
    "detectMention": True,
    "autoResponMessage": "Penting pc aja...",
    "responsticker": False,
    "changeGroupPicture":[],
    "notifikasi": False,
    "Sider":{},
    ...
    data = {
            ...
            "contents": {
             ...
             "hero": {
               ...
               "action": {
                 "type": "uri",
                 "uri": "https://line.me/ti/p/~bgstbgtya"
                 }
               },
                   "type": "bubble",
                   "body": {
...
def sendTextTemplateMaster(to, text):
  ...
  "styles": {
    ...
    "header": {
     ...
     "aspectRatio": "20:13",
     "aspectMode": "cover",
     "url": "https://i.imgur.com/FqHw5oM.jpg",
     "size": "full",
     "margin": "xl"
  },
  "footer": {
      ...
      "contents": [{
          ...
          "contents": [{
              ...
              "action": {
                  "type": "uri",
                  "label": "DPK",
                  "uri": "http://line.me/ti/p/~bgstbgtya"
              }
          }, {
              "flex": 3,
              "type": "button",
  ...
  "contents": [
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://i.imgur.com/FqHw5oM.jpg", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
    ...
    },
    {
      ...
      "footer": {
        ...
        "action": {
          "type": "uri",
          "uri": "http://line.me/ti/p/~bgstbgtyan",
        },
        "align": "center"
      },
      {
